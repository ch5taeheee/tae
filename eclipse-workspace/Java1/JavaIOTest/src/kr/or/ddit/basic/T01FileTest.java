...
public class T01FileTest {
	public static void main(String[] args) throws IOException {
		...
		System.out.println(file3.getName() + " 의 용량 크기 : " + file3.length() + "(bytes)"); // 파일 용량

		// 3. new File( String parent, String child)

		File file4 = new File(".\\D_Other\\test\\..", "test.txt"); // (상대)경로//내 위치에 따라 상대방의 위치가 달라질 수 있다. // START가
																	// .(현재경로(위치))이나 ..(상위디렉토리)으로 시작
