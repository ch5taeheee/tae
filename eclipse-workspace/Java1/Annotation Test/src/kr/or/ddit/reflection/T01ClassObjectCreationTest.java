 ...
 * 
 *   1. 리플렉션은 런타임 시점에 클래스 또는 멤버변수, 메서드, 생성자 등에 대한 정보를 가져오거나 수정할 수 있고, 새로운 객체를 생성하거나 메서드를 실행할 수 있다.
 *  	(컴파일 시점에 해당 정보를 알 수 없는 경우(소스코드 부재) 유용하게 사용될 수 있다.)
 *  
 ...
 *   - Field, Method, Construct, Modifier 등.
 *   
 */
	...
	public static void main(String[] args) throws ClassNotFoundException{
		...
		T01ClassObjectCreationTest object = new T01ClassObjectCreationTest();
		klass = object.getClass();
		
		// 세번째 방법 : .class 이용
		klass = T01ClassObjectCreationTest.class; // 하면 클래스 object 가 ..?
